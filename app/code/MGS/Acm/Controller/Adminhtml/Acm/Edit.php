...
class Edit extends \MGS\Acm\Controller\Adminhtml\Acm
{
    /**
     * Core registry
     *
    ...
    public function execute()
    {
        ...
        $this->_initAction()->_addBreadcrumb(
            ...
            $this->_view->getLayout()->createBlock('MGS\Acm\Block\Adminhtml\Edit')
        );
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Acm'));
