...
class Data extends \Magento\Framework\App\Helper\AbstractHelper {
    ...
    \Magento\Catalog\Model\Product $product
        ...
        if ($isEnabled) {
            ...
            return $result . '<button data-title="'. __("Quick View") .'" class="action mgs-quickview" data-quickview-url=' . $productUrl . ' title="' . __("Quick View") . '"><span class="fa fa-eye"></span></button>';
        }
        return $result;
    }
