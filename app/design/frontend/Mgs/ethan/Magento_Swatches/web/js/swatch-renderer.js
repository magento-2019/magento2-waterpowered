        ...
        updateBaseImage: function (images, context, isProductViewExist) {
            ...
            if (isProductViewExist) {
                ...
                if (this.options.onlyMainImg) {
					...
					var galleryLayout = $('#product_type_gallery').val();
					...
					if(imagesToUpdate.length == 1){
						...
						if(galleryLayout == 'quickview'){
							img_change = '<div class="product media"><div class="product-image-base"><div class="product-galley-image-carousel owl-carousel">';
							$.each(imagesToUpdate, function(index) {
								img_change = img_change + '<div class="item"><img class="img-responsive" src="'+imagesToUpdate[index]['full']+'" alt=""/></div>'
							});
							...
							$.each(imagesToUpdate, function(index) {
								...
								img_change = img_change + '<img src="'+imagesToUpdate[index]['thumb']+'" class="img-responsive" alt=""/>';
